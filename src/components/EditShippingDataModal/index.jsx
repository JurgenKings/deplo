...
import "../../components/CreateShippingDataModal/CreateShippingDataModal.css"

function EditShippingDataModal({ isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Hubo un error al editar tu dirección de envío, Por favor, inténtalo de nuevo.")
    } finally {
      setLoading(false)
    }
  }
        ...
        {loading ? (
          ...
          <div className="hidden-section">
            ...
            <span className="text-green-700">
              Se ha editado exitosamente tu dirección de envío predeterminada
            </span>
          </div>
        ) : (
            ...
            <div className="content">
              <form className="content-element-2" onSubmit={handleSubmit}>
                ...
                <div className="btn-set align-items-center jorge-container-button">
                  <button type="submit" className="btn btn-big">Editar</button>
                </div>
              </form>
            </div>
          </div>
